...
var _hackyOffsetParsesCorrectly = undefined;
var ianaZoneCache = {};
/**
...
var IANAZone = /*#__PURE__*/ (function (_Zone) {
  ...
  IANAZone.resetCache = function resetCache() {
    ianaZoneCache = {};
    dtfCache = {};
    _hackyOffsetParsesCorrectly = undefined;
  };
  /**
  ...
  IANAZone.getDtf = function getDtf(zone) {
    return makeDTF(zone);
  };
  /**
  ...
  IANAZone.hackyOffsetParsesCorrectly = function hackyOffsetParsesCorrectly() {
    if (_hackyOffsetParsesCorrectly === undefined) {
      var dtf = makeDTF("UTC");

      try {
        var _hackyOffset = hackyOffset(
            dtf, // arbitrary date
            new Date(Date.UTC(1969, 11, 31, 15, 45, 55))
          ),
          year = _hackyOffset[0],
          month = _hackyOffset[1],
          day = _hackyOffset[2],
          adOrBc = _hackyOffset[3],
          hour = _hackyOffset[4],
          minute = _hackyOffset[5],
          second = _hackyOffset[6];

        _hackyOffsetParsesCorrectly =
          year === 1969 &&
          month === 12 &&
          day === 31 &&
          adOrBc === "AD" &&
        ...
        _hackyOffsetParsesCorrectly = false;
      }
    }

    return _hackyOffsetParsesCorrectly;
  };
  /**
  ...
  _proto.offset = function offset(ts) {
    ...
    var _offsetComponentsFrom = offsetComponentsFromDtf(dtf, date),
      year = _offsetComponentsFrom[0],
      month = _offsetComponentsFrom[1],
      day = _offsetComponentsFrom[2],
      adOrBc = _offsetComponentsFrom[3],
      hour = _offsetComponentsFrom[4],
      minute = _offsetComponentsFrom[5],
      second = _offsetComponentsFrom[6];
  ...
  _proto4.eras = function eras$1(length, defaultOK) {
    ...
    return listStuff(this, length, defaultOK, eras, function () {
      ...
      if (!_this4.eraCache[length]) {
        _this4.eraCache[length] = [DateTime.utc(-40, 1, 1), DateTime.utc(2017, 1, 1)].map(function (
          dt
        ) {
