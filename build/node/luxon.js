...
function parseDataToDateTime(parsed, parsedZone, opts, format, text, specificOffset) {
  ...
  if (parsed && Object.keys(parsed).length !== 0) {
    const interpretationZone = parsedZone || zone,
      inst = DateTime.fromObject(parsed, { ...opts, zone: interpretationZone, specificOffset });
...
class DateTime {
  ...
  static _zoneOffsetGuessCache = {}; // CONSTRUCT
  ...
  toRelativeCalendar(options = {}) {
    ...
    return diffRelative(
      ...
      this,
      { ...options, numeric: "auto", units: ["years", "months", "days"], calendary: true }
    );
  }
  /**
